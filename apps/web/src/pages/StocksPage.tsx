      ...
      {result && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-dark-card border border-dark-border rounded-2xl p-8 max-w-md w-full text-center">
            ...
            <p className="text-zinc-400 mb-4">Your company has gone public!</p>
      ...
      {ipoStatus ? (
        ...
        <>
          ...
          <div className="bg-dark-card border border-dark-border rounded-2xl p-6">
            <h2 className="text-xl font-bold text-zinc-100 mb-4">Launch Your IPO</h2>

            <div className="bg-dark-elevated rounded-xl p-4 mb-6">
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                  <p className="text-sm text-zinc-500">Current Net Worth</p>
                  <p className="text-2xl font-bold text-zinc-100">
                    {formatCurrency(parseFloat(prestigeStatus?.currentNetWorth || '0'))}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-zinc-500">Required to IPO</p>
                  <p className="text-2xl font-bold text-zinc-100">
                    {formatCurrency(prestigeStatus?.minimumNetWorth || 100000)}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-zinc-500">Base Prestige Points</p>
                  <p className="text-2xl font-bold text-purple">
                    {prestigeStatus?.potentialPoints || 0} PP
                  </p>
                </div>
                <div>
                  <p className="text-sm text-zinc-500">IPO Multiplier Range</p>
                  <p className="text-2xl font-bold text-mint">0.7x - 1.5x</p>
                </div>
              </div>

              <div className="flex items-center gap-4 p-4 bg-amber/10 border border-amber/30 rounded-xl">
                <span className="text-3xl">⚠️</span>
                <div>
                  <p className="font-medium text-amber">IPO Risk Warning</p>
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-4 text-center">
                <p className="text-sm text-red-400">Minimum (0.7x)</p>
              ...
              <div className="bg-dark-elevated border border-dark-border rounded-xl p-4 text-center">
                <p className="text-sm text-zinc-400">Base (1.0x)</p>
                <p className="text-2xl font-bold text-zinc-300">
                  {prestigeStatus?.potentialPoints || 0} PP
                </p>
              </div>
              <div className="bg-mint/10 border border-mint/30 rounded-xl p-4 text-center">
                <p className="text-sm text-mint">Maximum (1.5x)</p>
          ...
          {/* How It Works */}
          <div className="bg-dark-card border border-dark-border rounded-2xl p-6">
            <h2 className="text-xl font-bold text-zinc-100 mb-4">How IPO Works</h2>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-dark-elevated rounded-xl p-4">
                <div className="text-3xl mb-2">1️⃣</div>
                <h3 className="font-bold text-zinc-100 mb-1">Launch IPO</h3>
              ...
              <div className="bg-dark-elevated rounded-xl p-4">
                ...
                <h3 className="font-bold text-zinc-100 mb-1">Watch the Market</h3>
                <p className="text-sm text-zinc-400">
              ...
              <div className="bg-dark-elevated rounded-xl p-4">
                ...
                <h3 className="font-bold text-zinc-100 mb-1">Time Your Exit</h3>
                <p className="text-sm text-zinc-400">
              ...
              <div className="bg-dark-elevated rounded-xl p-4">
                ...
                <h3 className="font-bold text-zinc-100 mb-1">Prestige & Grow</h3>
                <p className="text-sm text-zinc-400">
          ...
          <div className="bg-dark-card border border-dark-border rounded-2xl p-6">
            <h2 className="text-xl font-bold text-zinc-100 mb-4">Possible Market Events</h2>
