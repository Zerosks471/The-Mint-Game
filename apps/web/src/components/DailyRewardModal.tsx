          ...
          {isLoading ? (
            ...
            <div className="text-center py-4">
              ...
              <div className="bg-amber-50 rounded-xl p-6 mb-6">
                <p className="text-gray-600 text-sm mb-2">You received:</p>
            ...
            <>
              ...
              {/* Upcoming Rewards */}
              <div>
                <h3 className="font-bold text-gray-700 mb-3">Upcoming Rewards</h3>
                <div className="grid grid-cols-7 gap-2">
                  {status?.upcomingRewards.map((reward, index) => (
                    ...
                    >
                      ...
                      <p
                        className={`font-bold ${
                          reward.isMilestone ? 'text-purple-600' : 'text-gray-700'
                        }`}
                      >
                        {reward.day}
                      </p>
